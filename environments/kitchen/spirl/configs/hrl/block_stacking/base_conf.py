...
from environments.kitchen.spirl.rl.agents.skill_space_agent import ACSkillSpaceAgent
from environments.kitchen.spirl.models.skill_prior_mdl import ImageSkillPriorMdl
from environments.kitchen.spirl.configs.default_data_configs.block_stacking import (
    data_spec,
)
...
ll_agent_config.update(
    AttrDict(
        ...
        model_checkpoint=os.path.join(
            os.environ["EXP_DIR"], "skill_prior_learning/block_stacking/hierarchical"
        ),
    )
)
